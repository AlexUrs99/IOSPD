...
// This header created on Sun Aug  9 09:12:12 PDT 2015
...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x11F0, 0x0004, "FASTline UTP Quattr", "PCI\\VEN_8086&DEV_2772&SUBSYS_0CCB105B&REV_02\\3&2411E6FE&0&10" } ,
	{ 0x11F0, 0x4231, "1", "2" } ,
...
//	{ 0x8086, 0x027AE, "82945GM", "Mobile Intel(R) 945 Express Chipset Family" } ,
	{ 0x8086, 0x027A, "82945GM", "Mobile Intel(R) 945 Express Chipset Family" },
//	{ 0x8086, 0x027D8, "293esd", "High Definition Audio Controller" },
	{ 0x8086, 0x027D, "293esd", "High Definition Audio Controller" },
//	{ 0x8086, 0x0283E, "AA01211025", "Intel(R) ICH8 Family SMBus Controller" },
	{ 0x8086, 0x0283, "AA01211025", "Intel(R) ICH8 Family SMBus Controller" },
...
//	{ 0x8086, 0x04931028, "0x1502", "Intel 82579 Gigabit Network Card" } ,
	...
	{ 0x8086, 0x095B, "IntelÆ Dual Band Wireless-AC 7265", "IntelÆ Dual Band Wireless-AC 7265" } ,
	...
	{ 0x8086, 0x0124, "PCI\\VEN_8086&DEV_9C22", "24c6" },
...
//	{ 0x8086, 0x2653 & CC_0106, "82801FBM", "AHCI Controller" },
	...
	{ 0x8086, 0x0266, "VIA Technologies Vinyl AC'97 Codec Combo Driver (W", "VIA AC97 codec incorporated into VT82C686VT8251 SouthbridA/B, VT8231, VT8233/A/C, VT8235, VT8237/R" },
	...
	{ 0x8086, 0x0027, "82801G ", "ICH7 Family" },
...
//	{ 0x8086, 0x27DC0x27DC, "336C1462", "IntelÆ PRO/100 VE Desktop Adapter" } ,
	{ 0x8086, 0x27DC, "336C1462", "IntelÆ PRO/100 VE Desktop Adapter" },
...
//	{ 0x8086, 0x27RR, "ALC850", "no" } ,
	...
	{ 0x8086, 0x0284, "888", "Microsoft UAA bus for HD audio" },
...
//	{ 0x8086, 0x42231, "2915ABG", "Intel (R) PRO/Wireless 2200BG Network Connection, (R) PRO/Wireless 2915ABG Network Connection" } ,
	...
	{ 0x8086, 0x0482, "82375MB", "PCI\\VEN8086" },
...
//	{ 0x8086, 0x8086&DEV, "13258086&rev_00", "PCI\\VEN_8086&DEV_0083&SUBSYS_13258086&REV_00" } ,
	{ 0x8086, 0x8086, "13258086&rev_00", "PCI\\VEN_8086&DEV_0083&SUBSYS_13258086&REV_00" },
...
//	{ 0x8086, 0x9c3a Subsys_05eb1, "12", "PCI Simple Communication Controller" },
	...
	{ 0x8086, 0x0C50, "fd", "sdf" },
	{ 0x8086, 0xE13A, "7600", "NXMOQSN00430812D49" },
	{ 0x8086, 0x0F4E, "0F4E", "Intel(R) Pentium(R)/Celeron(R) processor N-/J- series PCI Express Root Port" } ,
...
//	{ 0x8086, 0xPCI\VEN_8086&DEV_3, "11583658", "PCI\\VEN_8086&DEV_3B64&SUBSYS_04821025&REV_06" } ,
	...
	{ 0x8086, 0x0999, "2930", "PCI\\VEN_8086&DEV_2930&SUBSYS_037E1014&REV_02\\3&61AAA01&0&FB" } ,
	...
	{ 0x1524, 0x0100, "ACPI/ENE0100/3&21436425&0", "ENE CIR Receiver" },
	...
	{ 0x1584, 0x4003, "VAS5052", "VAS Vetronix Automotive Service" },
	{ 0x1586, 0x0803, "", "" },
...
//	{ 0x15D7, RS56, "hcf cx11252-41z", "hcf 56" } ,
	...
	{ 0x15DD, 0x0769, "7690", "9200 HD –ê—É–¥–∏–æ –ö–û–î–ï–ö" },
...
//	{ 0x15E6, 0x00000002, "1646t00", "v.90 Lucent Modem" } ,
	...
	{ 0x15E7, 0x0755, "QUAD-P", "NTDS Parallel Adapter" },
...
//	{ 0x1814, 0x0301 (2), "RT2561", "Ralink RT2561 Wireless-G PCI" } ,
	...
	{ 0x1814, 0x0201, "25601814&REV_01", "Ralink RT2500 Wireless Lan Card" },
...
//	{ 0x1180, 0x05xx, "R5U8xx", "Ricoh R5U8xx Card Reader Driver - Win xp" } ,
	{ 0x1180, 0x0500, "R5U8xx", "Ricoh R5U8xx Card Reader Driver - Win xp" },
...
//	{ 0x197B, 0xJMB38, "JMB38X", "JMB38X SD/MMC Host Controller" } ,
	{ 0x04E8, 0x618c, "rev_0400", "usb lan adapter4" } ,
	{ 0x04E8, 0x618d, "rev_0400", "usb lan adapter4" } ,
	...
	{ 0x04B3, 0x0401, "8086", "PCI\\VEN_8086&DEV_293E&SUBSYS_20F217AA&REV_03\\3&B1BFB68&0&D8	" } ,
	{ 0x04B3, 0x0401, "24C5", "PCI\\VEN_8086&DEV_24C6&REV_03\\3 267A616A" } ,
	...
	{ 0x07d1, 0x3304, "graphic card", "802.11N usb wifi device" } ,
	{ 0x07d1, 0x3c03, "DWL-G122 Wifi PCI", "Same chipset of RALINK  RT2500" } ,
	{ 0x07d1, 0x3C07, "D-Link Wireless G DWA-110 USB Adapter", "PCI\\VEN_1799&DEV_700F&SUBSYS_700F1799&REV_20\\3&61AAA01&0&48" } ,
	...
	{ 0x05ac, 0x021e, "phone 3g", "Allumium keyboard it USB " } ,
	...
	{ 0x138A, 0x0011, "VFS5011", "Fingerprint Reader" } ,
...
//	{ 0x10EC, 0x06652, "ALC662", "5.1 channel audio codec" } ,
	{ 0x10EC, 0x0665, "ALC662", "5.1 channel audio codec" },
...
//	{ 0x10EC, 0x0C139, "5229", "PCIE RTS5229 Card Reader" } ,
	{ 0x10EC, 0x0C13, "5229", "PCIE RTS5229 Card Reader" },
...
//	{ 0x10EC, 0x5289Realtek , "RTL8411", " PCIE Card Reader" } ,
	...
	{ 0x10EC, 0x0662, "Realtek AC97Audio", "Realtek 171 High Definition Audio" } ,
...
//	{ 0x168C, 0x00027, "E017105B", "Atheros AR5B95 Wireless LAN 802.11 a/b/g/n Controller" } ,
	{ 0x168C, 0x0002, "E017105B", "Atheros AR5B95 Wireless LAN 802.11 a/b/g/n Controller" },
//	{ 0x168C, 0x00030, "PCI\\VEN_168C&DEV_0030&SUBSYS_16A810CF&REV_01", "TP-LINK 450Mbps Wireless N Adapter" },
	{ 0x168C, 0x0003, "PCI\\VEN_168C&DEV_0030&SUBSYS_16A810CF&REV_01", "TP-LINK 450Mbps Wireless N Adapter" },
...
//	{ 0x168C, 0x001c_again, "AR5BXB61", "AR5006EX AR5423a" } ,
	...
	{ 0x168C, 0x0002, "c660", "PCI/VEN_168C&DEV_002B&SUBSYS_7173144F&REV_01\\4&200004B7&0&00E1" } ,
	...
	{ 0x168C, 0x0032, "0x0280", "Dell Wireless DW1703 802.11b/g/n, BT4.0 + HS " } ,
...
//	{ 0x1002, 0x4380&CC_0106, "ATI RS690m", "AHCI Controller" } ,
	...
	{ 0x1002, 0x0439, "rv360", "ATI Technologies SB700 LPCHost Controller" } ,
	{ 0x1002, 0x4390, "SB750", "Integrated SATA II Controller" } ,
	{ 0x1002, 0x4391, "ATI SB700", "AHCI Controller" } ,
//	{ 0x1002, 0x4391&CC_0106, "AMD SB850", "AMD Southbridge incorporating AHCI 1.2 with SATA FISñbased switching support" } ,
...
//	{ 0x1002, 0x71C5 PCIE, "M56", "ATI MOBILITY /ATI RADEON X1600" } ,
	...
	{ 0x1002, 0x0079, "unknown, 2200 mhz", "Campo	Valor Juego de instrucciones	x86, x86-64, MMX, 3DNow!, SSE, SSE2, SSE3" } ,
	{ 0x1002, 0x0791, "RS690M", "ATI Mobility Radeon x1200" } ,
...
//	{ 0x1022, 0x7801_, "amd_sata", "AMD SATA Controller" } ,
	...
	{ 0x102B, 0x0532, "G200eW", "Matrox G200eW 8 MB DDR2 " } ,
...
//	{ 0x1039, &#65296;, "", "" } ,
	...
	{ 0x1039, 0x0191, "MTC ms9377c", "PCI /ven_1039" } ,
...
//	{ 0x103C, 0x0180000a, "0x00000000", "HID Keyboard Device" } ,
	...
	{ 0x103C, 0x0292, "E2924A", "PCI Host Interface Adapter" } ,
	...
	{ 0x103C, 0x0294, "qds brcm1051", "pci hostinterface" } ,
...
//	{ 0x104A, 0xSMO8810, "Unknown", "STMicroelectronics Freefall Sensor" } ,
	...
	{ 0x104E, 0x0317, "OTI107", "Spitfire VGA Accelerator" } ,
...
//	{ 0x1385, 0x81690, "GA630", "Fast Ethernet Adapter" } ,
	...
	{ 0x13F6, 0x0211, "pcnet ht2001 9932", "serl" } ,
//	{ 0x13F6, 0x00111, "520098396000734", "sound card" } ,
	{ 0x13F6, 0x0011, "520098396000734", "sound card" },
...
//	{ 0x13F6, 0x111, "PCI\\VEN_13F6&DEPCI\\VEN_13F6&DEV_0511&SUBSYS_051113", "C-Media Audio Controller" } ,
	{ 0x13F6, 0x0511, "PCI\\VEN_13F6&DEPCI\\VEN_13F6&DEV_0511&SUBSYS_051113", "C-Media Audio Controller" },
...
//	{ 0x0033, 0x00333, "OTI107", "Spitfire VGA Accelerator" } ,
	{ 0x0033, 0x0033, "OTI107", "Spitfire VGA Accelerator" },
...
//	{ 0x109E, 0x109E - 0x036E, "1822-0001", "0400 video devce" } ,
	{ 0x109E, 0x109E, "1822-0001", "0400 video devce" },
...
//	{ 0x10B9, 0x5229&REV_C5, "chipset", "PATA 133" } ,
	...
	{ 0x10B9, 0x0528, "52871849", "02\\3&267A616A" } ,
...
//	{ 0x10DE, 0x9876 03F0&SUBSYS_8, "N/A", "PCI(Has compatible Ids)" } ,
	...
	{ 0x10DE, 0x0DC4, "GTS 450", "NVIDIA GeForce GTS 450" } ,
	{ 0x10DE, 0x0DF5, "GT525M", "Nvidia GeForce GT525M" } ,
...
//	{ 0x10DF, 0xf9001, "1", "FC HBA" } ,
	...
	{ 0x9005, 0x041E, "AIC-9410W", "Razor ASIC" } ,
...
//	{ 0x1102, 0xC00D11BA, "ca0103-dbq", "sound  port for SB Live! Series" } ,
	...
	{ 0x1102, 0x1371, "PCI\\VEN_1274&DEV_1371&CC_040100", "" },
...
//	{ 0x1106, 0x1289a, "VT1708", "PCI\\VEN_1106&DEV_3059&SUBSYS_03011F6&REV_50\\3&13C0B0C5&0&8" } ,
	...
	{ 0x1106, 0x0204, "K8M400 chipset", "CPU " } ,
	...
	{ 0x1106, 0x0305, "VIA Sound VIA AC 97 in VT82C686A/B", "VIA AC 97 in VT8233/AC" } ,
...
//	{ 0x1106, 0x3068&CC_0780, "VT82C686A/B&VT8231", "MC97 MODEM" } ,
	...
	{ 0x1409, 0x7268, "PCI / ISA IEEE1284 ECP/EPP/SPP/BPP PAR4008A", "PCI parallel port" } ,
	{ 0x140B, 0x0610, "", "" } ,
	{ 0x140B, 0x0615, "NA", "Na" } ,
	{ 0x140B, 0x0682, "NA", "NA" } ,
	...
	{ 0x1425, 0x0031, "N/A", "T320 10GbE Dual Port Adapter" } ,
	{ 0x1425, 0x0032, "N/A", "T302 1GbE Dual Port Adapter" } ,
	{ 0x1425, 0x0033, "N/A", "T304 1GbE Quad Port Adapter" } ,
	{ 0x1425, 0x0034, "N/A", "B320 10GbE Dual Port Adapter" } ,
	{ 0x1425, 0x0035, "N/A", "S310-CR 10GbE Single Port Adapter" } ,
	{ 0x1425, 0x0036, "N/A", "S320-LP-CR 10GbE Dual Port Adapter" } ,
	{ 0x1425, 0x0037, "N/A", "N320-G2-CR 10GbE Dual Port Adapter" } ,
...
//	{ 0x14B1, 0x0FECF0000, "i865P/PE/G/i848P rev. A2", "Intel 82801EB (ICH5) rev. 02" } ,
	...
	{ 0x14E4, 0x0167, "BCM5751F", "NetXtreme Fast Ethernet Controller" } ,
...
//	{ 0x14E4, 0x1691_, "BCM57788A", "Broadcom NetLink (TM) Gigabit Ethernet" } ,
	...
	{ 0x14E4, 0x0333, "BCM53333", "16p 1G (PHY)" } ,
